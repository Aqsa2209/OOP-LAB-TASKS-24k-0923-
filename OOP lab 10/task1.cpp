...
### Changes Made:
- Added `using namespace std;` to simplify the code by allowing the use of standard library features without prefixing them with `std::`. 

### How to Use:
1. Compile the code using a C++ compiler.
2. Run the executable and enter the string you want to encrypt.
3. The program will display the original text, indicate that the encrypted text has been written to a file, and show the decrypted text after reading from the file.
